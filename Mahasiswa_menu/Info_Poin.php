...
<body>
    ...
    <div class="main">
        ...
        <div class="content">
            <h2>INFO POIN</h2>
            <p>Berikut ini adalah tabel data poin anda Dan klik tombol Cetak Form untuk mencetak surat pelanggaran anda</p>
            <table>
                <thead>
                    <tr>
                        <th>NIM</th>
                ...
                <?php foreach ($filtered_laporan as $laporan): ?>
                            <tr>
                                <td><?php echo htmlspecialchars($laporan['nim']); ?></td>
                                ...
                                <td><?php echo htmlspecialchars($laporan['bukti']); ?></td>
                                <td>
